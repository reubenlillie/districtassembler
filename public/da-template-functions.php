...
function action_da_order_priorities( $query ) {
...
/**
 * Opens the wrapping div tags on 'local_church' pages.
 *
 * @since 0.1.0
 *
 * @see wp_parse_args()
 ...
 */
function action_da_site_content_wrapper_open( $args ) {
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_da_site_content_wrapper_outer_open' );
	...
	if ( ! $args['outer_wrapper'] ) {
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_after_da_site_content_wrapper_outer_open' );
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_before_da_site_content_wrapper_inner_open' );
		...
		if ( ! $args['inner_wrapper'] ) {
			 ...
			 * @since 0.1.0
			 */
			do_action( 'do_after_da_site_content_wrapper_inner_open' );

} // action_da_site_content_wrapper_open()

/**
 * Closes the wrapping div tags on 'local_church' pages.
 *
 * @since 0.1.0
 *
 * @see wp_parse_args()
 ...
 */
function action_da_site_content_wrapper_close( $args ) {
	...
	$outer_wrapper = sprintf( '</%s><!-- ."%s" -->',
			 ...
			 * @since 0.1.0
			 *
			 * @hooked action_da_sidebar - 10
			 */
			do_action( 'do_before_da_site_content_wrapper_inner_close' );
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_after_da_site_content_wrapper_inner_close' );
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_before_da_site_content_wrapper_outer_close' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_site_content_wrapper_outer_close' );

} // action_da_site_content_wrapper_close()
...
/**
 * Adds a content header on single 'local_church' pages.
 *
 * @since 0.1.0
 *
 * @see wp_parse_args()
 ...
 */
function action_da_local_church_header_content( $args ) {
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_da_local_church_header_content_open' );
	...
	if ( ! $args['echo'] ) {
		 ...
		 * @since 0.1.0
		 *
		 * @hooked action_da_local_church_title_markup - 10
		 */
		do_action( 'do_after_da_local_church_header_content_open' );
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_before_da_local_church_header_content_close' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_local_church_header_content_close' );

} // action_da_local_church_header_content()
 ...
 * @return string The closing header tag.
 */
function action_da_archive_header_content( $args ) {
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_da_archive_header_content_open' );
	...
	if ( ! $args['echo'] ) {
		 ...
		 * @since 0.1.0
		 *
		 * @hooked action_da_archive_title_markup - 10
		 */
		do_action( 'do_after_da_archive_header_content_open' );
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_before_da_archive_header_content_close' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_archive_header_content_close' );

} // action_da_local_church_archive_header_content()
...
/**
 * Adds a content footer on single 'local_church' pages.
 *
 * @since 0.1.0
 *
 * @see wp_parse_args()
 ...
 */
function action_da_local_church_footer_content( $args ) {
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_da_local_church_footer_content_open' );
	...
	if ( ! $args['echo'] ) {
		 ...
		 * @since 0.1.0
		 *
		 * @hooked action_da_edit_post_link - 10
		 */
		do_action( 'do_after_da_local_church_footer_content_open' );
		 ...
		 * @since 0.1.0
		 */
		do_action( 'do_before_da_local_church_footer_content_close' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_local_church_footer_content_close' );

} // action_da_local_church_footer_content()
 ...
 * but only adds the title text on single 'local_church' pages.
 *
 * @since 0.1.0
 *
 * @see the_title()
 ...
 */
function action_da_local_church_title_markup() {
	 ...
	 */
	do_action( 'do_before_da_the_local_church_title' );

	if ( is_post_type_archive( 'local_church' )
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_the_local_church_title' );

} // action_da_local_church_title_markup()
...
function action_da_archive_title_markup() {
	 ...
	 */
	do_action( 'do_before_da_the_archive_title' );

	// Add the archive title inside an h1 tag by default.
	da_the_archive_title( '<h1 class="page-title">', '</h1>' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_the_archive_title' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_da_the_archive_description' );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_da_the_archive_description' );

} // action_da_archive_title_markup()

/**
 * Displays the archive title based on the queried object.
 *
 * Replaces WordPress' `the_archive_title()` for DistrictAssembler template files
 * so that the word **All** appears before the post type name
 * instead of **Archives:** when viewing the 'local_church' post type archive.
 *
 * This should make more sense from a reader's point of view,
 * since DistrictAssembler's 'local_church' archive page is basically like
 * reading the_ entire document_ made with DistrictAssembler
 * rather than an "archive" selected from a fewer number of such paragraphs.
 *
 * If you want something different than **All**
 * to display when viewing the 'local_church' post type archive,
 * then you should make your own modified copy of this function.
 *
 * Otherwise, use `apply_to_da_the_archive_title`
 ...
 */
function da_the_archive_title( $before = '', $after = '' ) {

	if ( is_post_type_archive( 'local_church' ) ) {

		$title = str_replace(
			'Archives: ',
			// translators: 'local_church' post type archive title
			_x( 'All ', 'districtassembler' ),
	 ...
	 * @since 0.1.0
	 */
	apply_filters( 'apply_to_da_the_archive_title', $title );

	if ( ! empty( $title ) ) {
		echo $before, $title, $after;
	}

} // da_the_archive_title()
 ...
 *
 * @param callback $da_sidebar The default sidebar.
 * @return callback A filtered sidebar, if applicable.
 */
function action_da_get_sidebar( $da_sidebar ) {

	/**
	 * DistrictAssembler's default sidebar.
	 *
	 * @since 0.1.0
	 * @var callback $da_sidebar
	 */
	 ...
	 * @since 0.1.0
	 */
	return apply_filters( 'apply_to_action_da_sidebar', $da_sidebar );

} // action_da_get_sidebar()
 ...
 */
function action_da_local_church_navigation( $args ) {

	$defaults = the_post_navigation( array(
			'next_text' => '<span class="meta-nav" aria-hidden="true">' .
								__( 'Next', 'districtassembler' ) .
							'</span> ' .
							'<span class="screen-reader-text">' .
								__( 'Next post:', 'districtassembler' ) .
							'</span> ' .
							'<span class="post-title">%title</span>',
			'prev_text' => '<span class="meta-nav" aria-hidden="true">' .
								__( 'Previous', 'districtassembler' ) .
							'</span> ' .
							'<span class="screen-reader-text">' .
								__( 'Previous post:', 'districtassembler' ) .
							'</span> ' .
							'<span class="post-title">%title</span>',
		)
	);
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_action_da_local_church_navigation' );

	if ( is_single( 'local_church' ) ) {
		 ...
		 * @since 0.1.0
		 */
		return apply_filters( 'apply_to_action_da_local_church_navigation', $args );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_action_da_local_church_navigation' );

} // action_da_local_church_navigation()
 ...
 */
function action_da_paragraphs_navigation( $args ) {

	$defaults = the_posts_pagination( array(
		'prev_text'          => __( 'Previous page', 'districtassembler' ),
		'next_text'          => __( 'Next page', 'districtassembler' ),
		'before_page_number' => '<span class="meta-nav screen-reader-text">' .
								__( 'Page', 'districtassembler' ) .
								' </span>',
		)
	);
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_action_da_paragraphs_navigation' );
	...
	if( is_post_type_archive( 'local_church' )
		 ...
		 * @since 0.1.0
		 */
		return apply_filters( 'apply_to_action_da_paragraphs_navigation', $args );
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_action_da_paragraphs_navigation' );

} // action_da_paragraphs_navigation()
...
/**
 * Displays the edit post link for 'local_church' custom post type.
 *
 * @since 0.1.0
 *
 * @see edit_post_link()
 ...
 */
function action_da_edit_post_link( $args ) {
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_before_action_da_edit_post_link' );

	// Parse incoming $args into an array and merge it with $defaults
	$args = wp_parse_args( $args, $defaults );

	edit_post_link(
		__( 'Edit', 'districtassembler' ),
	 ...
	 * @since 0.1.0
	 */
	do_action( 'do_after_action_da_edit_post_link' );

} // action_da_edit_post_link()
